...
class XilinxTMRVoter(Organ):
    ...
    def ensure_definition_in_netlist(self, netlist):
        ...
        primitive_definition = next(primitive_library.get_definitions("LUT3"), None)
        ...
        self._primary_input_pin = next(self._definition.get_ports("I0")).pins[0]
        self._other_input_pins = [next(self._definition.get_ports("I1")).pins[0],
                                  next(self._definition.get_ports("I2")).pins[0]]
        self._primary_output_pin = next(self._definition.get_ports("O")).pins[0]
...
class XilinxDWCDetector(Organ):
    ...
    def ensure_definition_in_netlist(self, netlist):
        ...
        primitive_definition = next(primitive_library.get_definitions("LUT2"), None)
        if primitive_definition is None:
            primitive_definition = primitive_library.create_definition()
...
class StickyDWCDetector(Organ):
    ...
    def ensure_definition_in_netlist(self, netlist):
        ...
        primitive_definition = next(primitive_library.get_definitions("sticky_detector"), None)
        if primitive_definition is None:
            primitive_definition = primitive_library.create_definition()
        ...
        self._primary_input_pin = next(self._definition.get_ports("I0")).pins[0]
        self._other_input_pins = [next(self._definition.get_ports("I1")).pins[0]]
        self._other_input_pins.append(next(self._definition.get_ports("rst")).pins[0])
        self._other_input_pins.append(next(self._definition.get_ports("clk")).pins[0])
...
class JTAG(Organ):
    ...
    def ensure_definition_in_netlist(self, netlist):
        ...
        primitive_definition = next(primitive_library.get_definitions("jtag"), None)
        if primitive_definition is None:
            primitive_definition = primitive_library.create_definition()

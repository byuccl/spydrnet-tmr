...
def fix_and_update_constraints(netlist, replicas, new_constraints_file, suffix="TMR"):
    '''
    ...
    In short, htis updates the replicated port parameters to reflect correct constraint values. Otherwise, all three domain ports will be constrained to the same pin and symbiflow will fail.
    ...
    '''
    updater = Constraints_Fixer(netlist, replicas, new_constraints_file, suffix)
...
class Constraints_Fixer():
    ...
    def read_new_constraints_file(self):
        with open(self.new_constraints_file, "r") as f:
